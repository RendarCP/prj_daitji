const LOCATION_IMAGE_PRESETS = [
  {
    key: "kitchen",
    label: "주방",
    src: "/images/locations/kitchen.svg",
    patterns: ["주방", "부엌", "kitchen", "pantry", "sink", "싱크"],
  },
  {
    key: "living-room",
    label: "거실",
    src: "/images/locations/living-room.svg",
    patterns: ["거실", "living", "lounge", "sofa", "tv"],
  },
  {
    key: "bedroom",
    label: "침실",
    src: "/images/locations/bedroom.svg",
    patterns: ["침실", "안방", "bedroom", "bed", "sleep"],
  },
  {
    key: "bathroom",
    label: "화장실",
    src: "/images/locations/bathroom.svg",
    patterns: ["화장실", "욕실", "bathroom", "restroom", "toilet", "bath"],
  },
  {
    key: "study",
    label: "서재",
    src: "/images/locations/study.svg",
    patterns: ["서재", "공부방", "작업실", "오피스", "study", "office", "desk"],
  },
  {
    key: "closet",
    label: "옷방",
    src: "/images/locations/closet.svg",
    patterns: ["옷방", "드레스룸", "드레스", "closet", "wardrobe", "dress"],
  },
  {
    key: "default-room",
    label: "기본 방",
    src: "/images/locations/default-room.svg",
    patterns: ["방", "room"],
  },
] as const;
